...
#global registry for models. This enables AllenNLP to dynamically instantiate this model by 
# name in configuration-driven workflows, without needing to reference the class directly in the code.
